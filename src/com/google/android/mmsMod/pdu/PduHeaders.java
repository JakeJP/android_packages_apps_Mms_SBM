...
public class PduHeaders {
	...
	/**
	 *  X-Mms-Vodafone-Notif-Text Softbank Japan's extension
	 */
	public static final byte [] X_MMS_VODAFONE_NOTIF_TEXT_STR = "X-Mms-Vodafone-Notif-Text".getBytes();
	public static final byte [] X_MMS_VODAFONE_NOTIF_EOL_STR = "X-Mms-Vodafone-Notif-EOL".getBytes();
    /**
